...
records1 <- read_csv("~/Dropbox/projects/Hopland - Kaitlyn dissertation/R/hopland-camera-traps/data/recordtable_phase1_cleaned30sec.csv")
records2 <- read_csv("~/Dropbox/projects/Hopland - Kaitlyn dissertation/R/hopland-camera-traps/data/recordtable_phase2_cleaned30sec.csv")
records <- rbind(records1, records2)


# Fix deer classifications ------------------------------------------------

## see code in 02-clean-deer-records.Rmd
